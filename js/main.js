              ...
              try {
                  ...
                  FB.api(url, function(response) {
                      ...
                      for(i=0; i<response.data.length; i++){
                          ...
                          var datestr = created_time.getFullYear() + "/" + ("0"+(created_time.getMonth()+1)).slice(-2) + "/" + created_time.getDate() + " " + created_time.getHours() + ":" + created_time.getMinutes() + ":" + created_time.getSeconds();
